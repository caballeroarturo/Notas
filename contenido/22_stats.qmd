...
Donde cada parte tiene un nombre técnico y un significado muy intuitivo:
* **$P(A|B)$ (Probabilidad Posterior):** La probabilidad de que ocurra $A$ (Resfriado) **dado que** ya observamos $B$ (Tos). Esto es lo que queremos descubrir.
* **$P(A)$ (Probabilidad Prior / A Priori):** Tu creencia inicial antes de ver la evidencia. ¿Qué tan común es tener un resfriado en la población?
