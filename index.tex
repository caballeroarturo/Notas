...
\date{Actualizado en septiembre, 2026}
...
\begin{center}
\includegraphics{www/1_marcusarendtmac.jpg}
\end{center}
...
\begin{center}
\includegraphics{www/2_OakeshottHayek.jpg}
\end{center}
...
\includegraphics{www/3_2_Popper.jpg}
...
\includegraphics{www/3_1_IsaiahBerlin.jpg}
...
\begin{center}
\includegraphics{www/4_1_linea_tiempo_pragmatismo.jpg}
\end{center}
...
\begin{center}
\includegraphics{www/4_3_pragmatismo.jpg}
\end{center}

\begin{center}
\includegraphics{www/4_2_autoritarismo.jpg}
\end{center}
...
\includegraphics{www/6_paradoja_libneg.jpg}
...
\includegraphics{www/6_paradoja_libpos.jpg}
...
\includegraphics{www/6_paradoja_repuclas.jpg}
...
\includegraphics{www/6_lib_rep.jpg}
...
\begin{center}
\includegraphics{www/07_ClasePolitica.png}
\end{center}
...
\includegraphics{www/08_poliarquia.png}
...
\chapter{Platformisation}\label{platfomisation}

Reporte de lectura de (\citeproc{ref-poell2019a}{Poell, Nieborg, y Dijck
2019}).

\begin{quote}
Poell, Thomas, David Nieborg, y José van Dijck. 2019. «Platformisation».
\emph{Internet Policy Review} 8 (4).
\url{https://doi.org/10.14763/2019.4.1425}.
\end{quote}

Los autores definen las plataformas como \emph{``infraestructuras
digitales (re) programables que facilitan y configuran interacciones
personalizadas entre usuarios finales y complementadores, organizadas
mediante la recopilación sistemática, el procesamiento algorítmico, la
monetización y la circulación de datos''}. La platformización se
entiende como la tendencia económica y tecnológica de transformar
actividades tradicionales en ecosistemas digitales intermediados por una
plataforma que extrae valor de las interacciones entre sus usuarios.
...
\item
  YouTube no produce la mayoría de sus videos; conecta creadores con
  espectadores y anunciantes.
\item
  Google Maps: apps como Uber, Cabify, Uber eats o ambulancias privadas,
  operan sobre la API de esta plataforma; estas aplicaciones dependen de
  esta plataforma para operar. En cuanto al comercio, los restaurantes
  dependen, en gran medida, de la visibilidad y la reputación en la app
  de Google.
\end{itemize}

Se observa una simultanea ``platformización de las infraestructuras'' y
``una infraestructuralización de las plataformas'', es decir, grandes
empresas de plataformas han surgido como el equivalente moderno de los
monopolios del ferrocarril, el teléfono y la electricidad de inicios del
siglo XX (\citeproc{ref-plantin2016}{Plantin et~al. 2016}).
...
\tightlist
\item
  Perdida de soberanía: plataformas como Twitter o Tiktok influyen,
  mediante algoritmos, no solo en lo que ve la ciudadanía al priorizar
  ciertos contenidos, sino también en que versión de la verdad es la que
  se debe ver.
\item
  Cuándo una plataforma tiene una caída, genera afectación mundial. Como
  la caída de windows o la AWS de años pasados.
\item
  Precarización del trabajo, como en el caso de Uber, Rappi o Didi.
\item
  Subdivisión del trabajo en microtareas, como en el caso de la
  enseñanza en la que los métodos de enseñanza se supeditan a los LMS
  (\emph{Learning Management Systems}), como Google Classroom, Moodle o
  Canvas.
\item
  Posición desigual de poder.
\end{itemize}

Las plataformas pueden pasar de ser una herramienta a convertirse en el
medio en el que vivimos, como el agua para los peces.

\chapter{Emociones en la política}\label{EmocionesNusbaum}
...
\includegraphics{www/12_1_DialConcreto_.png}
...
\chapter{Análisis geoespacial}\label{anuxe1lisis-geoespacial}

El espacio no es un área vacía donde suceden cosas, sino que es
producido a partir de las relaciones sociales de producción, las cuales
se reconfiguran y reconstituyen permanentemente de forma dialéctica
(\citeproc{ref-lefebvre2013}{Lefebvre 2013}).

Podemos pensar en el espacio como producto de las relaciones sociales,
pero también como productor de esas relaciones sociales que lo originan.
Desde este punto de vista, las relaciones sociales no simplemente se
producen en el espacio, sino que producen espacio
(\citeproc{ref-castillofarjat2026}{Castillo Farjat 2026}).

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\item
  El Espacio como ``Socionaturaleza''

  La sociedad y la naturaleza no pueden analizarse de forma separada ya
  que son dialécticamente coproducidas (\citeproc{ref-bear2017}{Bear
  2017}). El análisis socioespacial debe abordar cómo el capitalismo
  actúa como una \textbf{manera de organizar la naturaleza},
  convirtiendo elementos vitales (como el agua) en mercancías mediante
  infraestructura y discursos de poder.
\item
  Noción de ``Rugosidades''

  Basándose en Milton Santos, Castillo propone que el espacio es
  \textbf{historia acumulada}. El análisis socioespacial debe
  identificar las \textbf{``rugosidades''}, que son lo que permanece del
  pasado como forma, espacio construido, paisaje, lo que resta del
  proceso de supresión, acumulación, superposición, a través del cual
  las cosas se sustituyen y acumulan en todos los lugares''
  (\citeproc{ref-santos2005a}{Santos 2005}). Estas rugosidades alimentan
  una \textbf{memoria geográfica} que las comunidades utilizan como
  defensa política frente a nuevas amenazas de despojo
  (\citeproc{ref-castillofarjat2023}{Castillo Farjat 2023a}).
\item
  Memoria geográfica

  Producción social de carácter político que las poblaciones esgrimen
  ante una propuesta o proyecto que amenaza reproducir un proceso previo
  de despojo por parte del gobierno o de alguna dependencia, proceso que
  ha dejado un sentimiento de valoración negativa en la comunidad
  (\citeproc{ref-peuxf1agarcuxeda2019}{Peña García 2019, 38}). Ello
  sugiere la existencia de una suerte de memoria de los agravios que
  deriva en distintas prácticas espaciales de resistencia o
  contrahegemónicas (\citeproc{ref-castillofarjat2023a}{Castillo Farjat
  2023b}).
\item
  La Colonialidad del Salario y el Trabajo

  Un aporte distintivo en su visión es el análisis de la
  \textbf{división racial y de género del trabajo} inscrita en el
  espacio. Acuña el concepto de \textbf{``colonialidad del salario''}
  para explicar cómo el sistema capitalista excluye a la población
  racializada y feminizada de las relaciones salariales formales,
  apropiándose de su trabajo no remunerado para sostener la acumulación
  de capital en los centros de poder.
\item
  Territorios Autónomos y Autogestión
\end{enumerate}

Para Castillo Farjat, el espacio es la \textbf{expresión geográfica de
la lucha de clases}. Por ello, su análisis se enfoca en los
\textbf{espacios de resistencia} y los \textbf{territorios autónomos},
definidos por la capacidad de las comunidades para:

• \textbf{Autogestionarse y autogobernarse} sin jerarquías
institucionalizadas.

• Poner la \textbf{reproducción de la vida} y el bien común por encima
de la acumulación de capital.

• Generar una \textbf{espacialidad contrahegemónica} mediante el trabajo
colectivo (como el tequio) y la búsqueda de autosuficiencia.

\section{Cartografía}\label{cartografuxeda}

\subsection{Conceptos fundamentales}\label{conceptos-fundamentales}

La cartografía se define como el arte, la ciencia y la técnica de
confeccionar y estudiar los mapas en todos sus aspectos. Un mapa es una
representación gráfica de un aspecto del mundo real, tradicionalmente
visto como una ``ventana transparente'', aunque también puede entenderse
como una construcción social cargada de intenciones. Existen conceptos
clave para evaluar la calidad de la información cartográfica:

\begin{itemize}
\tightlist
\item
  Exactitud: El grado de cercanía entre la posición de un objeto en el
  mapa y su ubicación real en la superficie terrestre.
\item
  Precisión: Se refiere a la consistencia de las medidas y al nivel de
  detalle o número de dígitos significativos con los que se registran
  los datos.
\item
  Resolución espacial: Es la unidad de medida más pequeña adoptada para
  registrar datos (el ``granulado''), que determina el nivel de detalle
  y nitidez de la representación.
\item
  Entidades y Geometría: Los rasgos geográficos se representan mediante
  puntos (coordenadas X, Y), líneas (sucesión de puntos) y áreas
  (superficies cerradas), cada una asociada a atributos descriptivos en
  una base de datos.
\end{itemize}

\subsection{Síntesis histórica}\label{suxedntesis-histuxf3rica}

La historia de la cartografía ha evolucionado de ser una ``ciencia de
príncipes'' utilizada para administrar el poder, la guerra y el imperio,
hacia una disciplina científica y tecnológica moderna

\begin{itemize}
\tightlist
\item
  Poder y Control: Históricamente, los mapas fueron herramientas del
  imperialismo para legitimar conquistas y del Estado-nación para
  delimitar fronteras y derechos de propiedad.
\item
  Secretismo: En los siglos XVI y XVII, existieron políticas de secreto
  cartográfico (como en la Casa de Contratación de España) para
  monopolizar el conocimiento geográfico como recurso económico y
  estratégico.
\item
  Automatización: A partir de 1930, el racionalismo y el cuantitativismo
  prepararon el camino para la Geografía Automatizada de los años 60,
  que culminó en los actuales Sistemas de Información Geográfica (SIG).
\end{itemize}

\subsection{El programa cartográfico y los elementos del
mapa}\label{el-programa-cartogruxe1fico-y-los-elementos-del-mapa}

La producción cartográfica profesional implica el ensamblaje de diversos
elementos para comunicar información de manera efectiva:

\begin{itemize}
\tightlist
\item
  Cuerpo del mapa: La parte más importante, que contiene la información
  geográfica
\item
  Título: Sugiere el tema o contenido del mapa.
\item
  Leyenda: Relaciona los símbolos cartográficos con los rasgos reales
  del terreno.
\item
  Escala (gráfica o numérica): Indica la relación de reducción entre el
  mapa y la realidad.
\item
  Orientación (flecha de norte): Indica la dirección del norte.
\item
  Otros: Fuente de datos, nombre de la proyección, recuadros (inset
  maps) e información de calidad.
\end{itemize}

\subsection{Simbología
cartográfica}\label{simbologuxeda-cartogruxe1fica}

La simbología permite representar características de localización y
atributos mediante el uso de variables visuales aplicadas a puntos,
líneas y áreas

\begin{itemize}
\tightlist
\item
  Variables visuales principales: Incluyen el tono (hue), valor
  (claridad/oscuridad), croma (intensidad), tamaño, forma, textura y
  patrón
\item
  Mapas temáticos: Utilizan símbolos específicos como los coropléticos
  (sombreado de áreas por estadísticas), símbolos proporcionales o
  cartogramas (donde el tamaño de la unidad es proporcional a una
  variable)
\item
  Clasificación de datos: Los datos cuantitativos se agrupan mediante
  métodos como intervalos iguales, cuantiles, cortes naturales (Jenks) o
  desviación estándar para facilitar su interpretación visual
\end{itemize}

\subsection{Manejo de la escala
numérica}\label{manejo-de-la-escala-numuxe9rica}

La escala es la relación matemática de proporción entre una distancia
medida en el mapa y su correspondiente distancia en el terreno

\begin{itemize}
\tightlist
\item
  Representación: Se expresa como una fracción (ej. 1:50,000, donde 1 cm
  equivale a 50,000 cm o 500 m en la realidad).
\item
  Escalas grandes vs.~pequeñas: Una escala de 1:24,000 es ``grande''
  porque muestra mucho detalle de un área pequeña, mientras que una de
  1:1,000,000 es ``pequeña'' porque cubre áreas extensas con poco
  detalle.
\item
  Implicaciones: La elección de la escala no es neutral; es una
  herramienta que determina qué nivel de agregación, simplificación y
  límites tendrá el objeto de estudio.
\end{itemize}

\subsection{Proyecciones
cartográficas}\label{proyecciones-cartogruxe1ficas}

Una proyección es el proceso sistemático de transformar la superficie
curva de la Tierra (elipsoide o esfera) en un plano bidimensional, lo
cual siempre genera distorsiones

\begin{itemize}
\tightlist
\item
  Por superficie de proyección: Se clasifican en cilíndricas, cónicas y
  azimitales (planas) Por propiedad preservada:
\item
  Conformes: Preservan ángulos y formas locales (ej. Lambert o
  Mercator).
\item
  Equivalentes (Equal-area): Mantienen las áreas en tamaño relativo
  correcto (ej. Albers).
\item
  Equidistantes: Mantienen la escala constante a lo largo de ciertas
  líneas.
\item
  Datum: Es fundamental referenciar la proyección a un Datum (como WGS84
  o NAD83), que define el tamaño, forma y posición del elipsoide
  respecto al centro de la Tierra.
\end{itemize}

\subsection{Pensamiento espacial}\label{pensamiento-espacial}

Se refiere al desarrollo de una inteligencia espacial y a la capacidad
de conceptualizar la realidad a través de componentes espaciales. Es el
conocimiento que un individuo utiliza para resolver problemas espaciales
o de imágenes espaciales. De acuerdo a Piaget, el espacio práctico y
socio-motor genera intuiciones espaciales básicas, permitiendo que los
niños representen mejor los espacios que ya conocen.

\begin{itemize}
\tightlist
\item
  Conceptos base: Incluyen la localización, distribución espacial,
  asociación, interacción y evolución.
\item
  Mapas mentales: Son representaciones internas que codificamos en el
  cerebro basadas en nuestras actividades cotidianas y movilidad; son
  únicos para cada individuo y reflejan sus procesos de abstracción.
\item
  Utilidad: Permite resolver problemas complejos, desde encontrar una
  ruta óptima hasta la planificación urbana.
\end{itemize}

\subsection{Interpretación del
territorio}\label{interpretaciuxf3n-del-territorio}

Interpretar el territorio a través de la cartografía va más allá de
observar ``accidentes geográficos''; implica entender el mapa como un
discurso persuasivo y retórico

\begin{itemize}
\tightlist
\item
  Análisis socioespacial: Utiliza los mapas para analizar la eficiencia,
  equidad y diferencias socioespaciales con el fin de mejorar la calidad
  de vida.
\item
  Búsqueda de ``silencios'': La interpretación crítica requiere
  identificar qué elementos han sido omitidos o censurados (por razones
  militares, políticas o comerciales), ya que lo que no se muestra es
  tan significativo como lo que sí.
\item
  Dimensión simbólica: Los mapas actúan como metáforas de valores
  culturales, religiosos o nacionales, donde la precisión técnica a
  menudo se convierte en un símbolo de autoridad y legitimidad.
\end{itemize}

\section{Metadatos}\label{metadatos}

En el análisis espacial, los metadatos se definen fundamentalmente como
``datos sobre los datos''; es decir, información estructurada que
describe el contenido, la calidad, la condición y otras características
de un conjunto de datos para facilitar su búsqueda, recuperación y
gestión.

\begin{itemize}
\tightlist
\item
  Dublin Core: Es un estándar de metadatos interoperable diseñado
  específicamente para la descripción y recuperación de recursos en red
  (Internet)
\item
  CSDGM (Content Standard for Digital Geospatial Metadata): Desarrollado
  por el FGDC de Estados Unidos, proporciona una terminología y
  definiciones comunes para documentar datos geoespaciales digitales,
  cubriendo aspectos como calidad, organización espacial y referencia
  técnica
\item
  ISO 19115: Es la norma internacional que establece el marco para
  describir la información geográfica y sus servicios, detallando la
  identificación, extensión, calidad y los derechos de uso de los datos
  digitales
\end{itemize}
...
\begin{table}
\caption*{
{\fontsize{18}{22}\selectfont  \textbf{Línea de Tiempo}\fontsize{12}{15}\selectfont } \\ 
{\fontsize{14}{17}\selectfont  Fechas destacadas\fontsize{12}{15}\selectfont }
} 
\fontsize{12.0pt}{14.0pt}\selectfont
\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}lllllc}
\toprule
Evento\textsuperscript{\textit{1}} & Fecha & Observaci\\'on & Contexto & Inflexi\\'on & Bibliograf\\'ia \\ 
\midrule\addlinespace[2.5pt]
Her\\'odoto:  
Monarqu\\'ia: gobierno de uno solo.
Aristocracia: gobierno de algunos.
Democracia: gobierno de todos. & NA & NA & Lo que Arist\\'oteles llam\\'o \guillemotleftdemocracia\guillemotright no era sino una aristocracia m\\'as extendida, en todos los estados griegos, por aristocr\\'aticos o democr\\'aticos que fuesen, hab\\'ia
siempre una o poqu\\'isimas personas que ten\\'ian influencia preponderante & NA & NA \\ 
Maquivelopublica Discursos sobre la primera d\\'ecada de Tito Livio. & 1520 & NA & NA & NA & NA \\ 
Thomas Hobbes:  
El monopolio del poder pol\\'itico garantiza la supervivencia de la comunidad, ya que cualquier divisi\\'on del poder pone en debilidad al Estado. No acepta la existencia de partidos. El hombre es el lobo del hombre.   & 1651  & Thomas Hobbes p\\'ublica el Leviat\\'an  & 1632 Galileo p\\'ublica que la tierra gira alrededor del sol.   & NA & NA \\ 
De Corpore (Thomas Hobbes): Describes reasoning as computation. To compute is to collect the sum of many things added together at the same time, or to know the remainder when one thing has been taken from another. To reason therefore is the same as to add or to subtract\textquotedblright (Hobbes 1655, 1.2). El soberano es elegido por medio de un pacto, no es elegido por Dios no necesariamente es el m\\'as apto.   & 1655  &   &   & NA & NA \\ 
  & 1689  & (1684-1685) Leyes de Newton.   & Revoluci\\'on de Inglaterra  & NA & NA \\ 
John Lockep\\'ublica los tratados sobre :
Refutaci\\'on del gobierno por derecho divino 
Oposici\\'on al Leviat\\'an de Thomas Hobbes (ensayo sobre el entendimiento humano)
- Defend\\'ia el tratado social en el que se conced\\'ia la soberan\\'ia al estado. Se le considera el padre del liberalismo moderno. Sus ideas se consideran base de la constituci\\'on de EUA y de Francia. & 1690 & John Locke: Derecho a la vida, a la libertad y a la propiedad; son inalienables. En el estado el poder supremo es el legislativo; el poder ejecutivo y judicial est\\'an unidos. Aboga por una educaci\\'on apta para formar un \textquotedblleftgentleman\textquotedblright capaz de ser \\'util a s\\'i mismo y a su patria & NA & NA & NA \\ 
El esp\\'iritu de las leyes (Montesquieu): "Dividir el poder para preservar la libertad". "la libertad pol\\'itica no es dar permiso para hacer lo que queramos, ni incluso para hacer lo que permite la ley, sino s\\'olo "el poder de hacer lo que deber\\'iamos querer".  & 1748  & "Todo hombre que tiene poder siente la inclinaci\\'on de abusar de \\'el" Montesquieu 

El estado se divide en Ejecutivo, Legislativo y Judicial. C\\'amara de los Lores (nobles) y C\\'amara de los comunes (pobres). &   & NA & NA \\ 
  & 1775  & Declaraci\\'on de independencia EUA  &   & NA & NA \\ 
John Adams:  
Presidente de EUA que us\\'o la frase "Tiran\\'ia de las mayor\\'ias" en la democracia aludiendo a la preocupaci\\'on por el autoritarismo mayoritario. & 1788  & Un riesgo inherente a los sistemas democr\\'aticos es la posibilidad de abuso de los derechos de minor\\'ias \\'etnicas, religiosas o pol\\'iticas por parte de las mayor\\'ias.  &   & NA & NA \\ 
Declaraci\\'on de los derechos del hombre y del ciudadano(Francia)  & 1789  & Un Ciudadano es un miembro pleno de una comunidad que tiene los mismos derechos que los dem\\'as y las mismas oportunidades de influir en el destino de la comunidad.  & NA & NA & NA \\ 
Hegel (Elements of the Philosophy of Right):  & 1821  &   & - M\\'exico, Per\\'u y  Chile culminan su independencia en  1821.
- M\\'exico, Honduras, Guatemala, Nicaragua, Costa Rica y el Salvador celebran su independencia el 15 de septiembre & NA & NA \\ 
Tocqueville (Franc\\'es) no vio a la democracia como un sistema de libertad, sino de poder.  
"Resulta evidente que si cada ciudadano, a medida que se va haciendo individualmente m\\'as d\\'ebil y, por consiguiente, m\\'as incapaz de preservar por s\\'i solo su libertad no aprende el arte de unirse a sus semejantes para defenderla, la tiran\\'ia crecer\\'a necesariamente con la igualdad. & 1835  & Tocqueville publica la democracia en Am\\'erica, primera parte.  

Los ciudadanos salen por un momento de la dependencia para elegir a su amo, y vuelven luego a ella. & Texas declara su independencia de M\\'exico.  & NA & NA \\ 
Marx:
1. Expropiaci\\'on de la propiedad inmueble y aplicaci\\'on de la renta del suelo a los gastos p\\'ublicos.
2. Fuerte impuesto progresivo
3. Abolici\\'on del derecho de herencia
4. Confiscaci\\'on de la fortuna de los emigrados y rebeldes.
5. Centralizaci\\'on del cr\\'edito en el estado por medio de un banco nacional con capital estatal y un monopolio exclusivo
6. Nacionalizaci\\'on de los transportes.
7. Multiplicaci\\'on de las f\\'abricas nacionales y de los medios de roturaci\\'on de terrenos con arreglo a un plan general
8. Proletarizaci\\'on del deber general de trabajar, creaci\\'on de ej\\'ercitos industriales, particularmente en el campo.
9. Articulaci\\'on de las explotaciones agr\\'icolas e industriales, tendencia a borrar las diferencias entre el campo y la ciudad.
10. Educaci\\'on pol\\'itica y gratuita de todos los ni\~nos, prohibiciones del trabajo infantil. Combinar el estudio con el trabajo. & 1843  & Marx p\\'ublica "Introducci\\'on a la cr\\'itica de la filosof\\'ia del derecho de Hegel".

1848: Marx publica el Manifiesto Comunista, junto con Engels.  

Plantea la necesidad de pasar de la cr\\'itica de la religi\\'on a la cr\\'itica de las formas profanas de alineaci\\'on, y del estado en primer lugar.
...
John Stuart Mill: 
P\\'ublica "Utilitarismo": las acciones son buenas (socialmente \\'utiles o valiosas) si contribuyen al logro de la felicidad general y malas si no la consiguen (Benthan); Mill a\~nadi\\'o: "algunos tipos de placer son m\\'as deseables y valiosos que otros".
Los mayores riesgos para la libertad vienen de los propios particulares, cuando ejercen eso que Mill no dudaba en calificar como "tiran\\'ia de la opini\\'on y sentimiento prevalecientes" en una sociedad. & 1861  & John Stuart Mill:  
Consideraciones sobre el gobierno representativo (1861). Expresa la conveniencia de otorgar un voto de calidad a favor de los individuos que tuvieran superioridad mental. & 1856: Nac\\'e Sigmund Freud dentro de una familia jud\\'ia en lo que ahora es la Rep\\'ublica Checa
1858: Nac\\'e Gaetano Mosca en Palermo, Italia. Senador Vitalicio tanto en la Monarqu\\'ia como en el Fascismo.
1862: Nace David Hilbert & NA & NA \\ 
1889: Nace Hayek en Vienna 
1898 Nace Herbert Marcus (jud\\'io alem\\'an) & 1867 & Marx p\\'ublica 3 vol\\'umenes de su obra "El capital"  & 1874 - 1884: Cantor establece el origen de la teor\\'ia de Conjuntos. La hip\\'otesis del continuo esconcluidaen los problemas del siglo de Hilbert. & NA & NA \\ 
...
1896: Gaetano Mosca publica "Elementi di Scienza Politica". La sociedad muestra, en todas sus \\'epocas de desarrollo hist\\'orico a dos grupos sociales, la clase gobernante y la gobernada. & 1896 & NA & NA & NA & NA \\ 
1901: Nace Oakeshott (ingl\\'es) 
1902: Nace Karl Popper (jud\\'io - Vienna)
1906: Nace Hanna Arendt (jud\\'io alemana)
1909: Nace Isaiah Berl\\'in en Rusia (jud\\'io - Letonia)
1911: Nace Macpherson en Canad\\'a & 1900  & David Hilbert:
Presenta los problemas del siglo XX en el Congreso Internacional de Matem\\'aticas de Par\\'is. & 1914-1918 Primera guerra mundial 
1917-1923 Revoluci\\'on Rusa de Feb. Y Oct. & NA & NA \\ 
NA & 1922 & NA & 1922: llega al poder el Partido Fascista dirigido por Benito Mussolini bajo el reinado de V\\'ictor Manuel III (1900-1946).
1922 El fascismo se vuelve dictadura
1922 Se crea la URSS & NA & NA \\ 
Nace J\"urgen Habermas en 1929 en D\"usseldorf, Alemania

1930:Sigmund Freudpublica \textquotedblleftCivilization and its Discontents\textquotedblright & 1929  & Crisis del 29.   & 1926: Antonio Gramsci es encarcelado.
1926: Nace Michael Foucault en Francia. & NA & NA \\ 
G\"odel
Demuestra dos teoremas de incompletitud & 1931 & Primer teorema de incompletitud \textemdash
Dado un sistema T creado a partir de un conjunto de axiomas decidible donde toda relaci\\'on recursiva es expresable en T y que sea consistente, entonces T tiene un indecidible y por lo tanto es incompleta.
...
1938: Nace Robert Nozick en el seno de una familia con descendencia jud\\'ia. & 1942  & Asimovescribe por primera vez sobre psicohistoria  & Norberto Bobbio (Profesor de Bovero) fue arrestado entre 1942 y 1943 por ser parte de un grupo antifacista. & NA & NA \\ 
Friedrich Hayek: 
Ser humano: Es un propietario, un agente de intercambio. 
Libertad: La libertad negativa es lo privado, la positiva es lo p\\'ublico. Se tiene derecho a la propiedad privada. La rep\\'ublica no es un fin sino un medio para alcanzar la libertad; propone pol\\'iticas de bienestar social solo para defender a los ciudadanos de los actos de desesperaci\\'on de quienes carecen de lo indispensable.   & 1944  & Se publicaCamino de servidumbre de Hayek(bestseller) 
Igualdad es igualdad ante la ley, y el premio es por los logros, nunca por los m\\'eritos o esfuerzos. La igualdad sustantiva destruye el estado de derecho. & 1943: Hambruna bengal\\'i en India.
En 1945 se termina la 2da guerra mundial. 
1947: India obtiene su independencia de los Brit\\'anicos. & NA & NA \\ 
Karl Popper 
...
1949: Orwell publica su novela \textquotedblleft1984\textquotedblright. & NA & NA \\ 
NA & 1955 & NA & 1955: Inicia la Guerra de Vietnam
1955: Las mujeres votan por primera vez en M\\'exico en una elecci\\'on Federal, de acuerdo a la ley publicada en el DOF en 1953. & NA & NA \\ 
Isaiah Berl\\'in 
<<El \\'ambito que tiene mi libertad social o pol\\'itica no solo consiste en la ausencia de obst\\'aculos que impidan mis decisiones reales, sino tambi\\'en en la ausencia de obst\\'aculos que impidan mis decisiones posibles, para obrar de una manera determinada, si eso es lo que decido>>
Isaiah Berl\\'in publica "Two Concepts of Liberty"  Libertad positiva y libertad negativa. & 1958  & 1958: John Rawls p\\'ublica \textquotedblleftJusticia como equidad\textquotedblright. & 1958: Hayek se une a la Universidad de Chicago.
1959: Amartya Sen obtiene su doctorado en la Universidad brit\\'anica de Cambridge
...
1961: Crisis de los misiles en Cuba y construcci\\'on del muro de Berl\\'in. Yuri Gagarin es el primer humano que orbita la tierra. & NA & NA \\ 
Michael Oakeshott:  
La teor\\'ia nace de la pr\\'actica: No hay derecho ni norma moral que sea "inmune a las vicisitudes del tiempo y el lugar". Denuncia la tiran\\'ia que el presente ejerce sobre el pasado a trav\\'es de las reinterpretaciones.
La pol\\'itica se divide en Pol\\'itica de la Fe (cambiar el mundo que les rodea a partir de sus capacidades racionales, usando como palanca las instituciones pol\\'iticas). Pol\\'itica del escepticismo (Basado en la tradici\\'on y el sentido com\\'un). Libertad civil: no tener que compartir ning\\'un prop\\'osito (common purpose) con los dem\\'as civiles. La elecci\\'on colectiva es lo contrario a la libertad. & 1962  & Published "Rationalism in Politics," a critique of modern political ideologies. 

La rep\\'ublica es un elenco de tradiciones de comportamiento o "moral practices". No se le puede atribuir autoridad de cualquier tipo, sea de un gobernante, una mayor\\'ia de cives o una supuesta voluntad general.

1962:Habermas publica el libro "The structural transformation of the public sphere"
Esfera privada: vida familiar, vecindad y la asociaci\\'on voluntaria.
La esfera p\\'ublica fue subsumida en el marco del consumo, una empresa conducida por el mercado que en parte consiente y en parte manipula a una masa cultural tan acr\\'itica como apol\\'itica. [p160]
 &   & NA & NA \\ 
Karel Kos\\'ikpublica "Dialectica de lo concreto". & 1963 & NA & 1963: Robert Nozik es catedr\\'atico de Harvard, donde coincide con Rawls.
1963: Mart\\'in Luther King pronuncia el Discurso "I have a dream". Marcha por los trabajadores en Washington. & NA & NA \\ 
Herbert Marcuse:  & 1964  & PublicaEl hombre unidimensional  & 1964: Mart\\'in Luther King recibe el premio Nobel de la Paz & NA & NA \\ 
Michael Foucault:
...
Pablo IV:  
\textquotedblleft[\textellipsis] en los designios de Dios, cada hombre est\\'a llamado a promover su propio progreso, porque la vida de todo hombre es una vocaci\\'on dada por Dios para una misi\\'on concreta\textquotedblright (PP, 15)". & 1967  & El 28 de marzo del a\~no 1967 elPapa Pablo VI publicaba su enc\\'iclica Populorum progressio. El d\\'ia de Pascua.  

Rorty, Richard. publica en 1967 Chicago: The Linguistic Turn: Recent Essays in Philosophical Method & Guerra de los seis d\\'ias (Israel conquista el Sina\\'i y los Altos del Golan). & NA & NA \\ 
Habermas p\\'ublica: \textquotedblleftConocimiento e inter\\'es\textquotedblright. Obre escrita contra el positivismo y la ciencia positivista. & 1968 & NA & 1968: Plaza de las tres culturas, Tlatelolco, M\\'exico 68.
1968: Primavera de Praga, intento de democratizar el socialistamo ("Socialismo con rostro humano"). & M\\'exico & NA \\ 
Michael Foucault:
...
1971:John Rawlspublica el libro \textquotedblleftUna teor\\'ia de la justicia\textquotedblright.
(Primer principio) Toda persona ha de tener igual derecho al sistema m\\'as extenso de libertades b\\'asicas iguales que sea compatible con un sistema semejante de libertades para todos.
(Segundo principio) Las desigualdades sociales y econ\\'omicas habr\\'an de ser ordenadas tal que: est\\'en dirigidas hac\\'ia el mayor beneficio del menos aventajado. Se vinculen a cargos y posiciones abiertos a todos bajo las condiciones de una equitativa igualdad de oportunidades.
...
Robert Nozick:
Publica "Anarqu\\'ia, Estado y Utop\\'ia" en respuesta al libro de Rawls "A theroy of justice". En su libro defiende el libertarismo, propone el Estado M\\'inimo y establece la Teor\\'ia del t\\'itulo justo (entitlement theory). & 1974  & NA & Hayekreceived the Nobel Prize in Economics for his work on money and economic fluctuations
1973: EUA retira sus tropas de Vietnam.
1973: Crisis del Petroleo en relaci\\'on a la guerra del Yom Kipur, guerra del Ramad\\'an o guerra de Octubre.
1973: Golpe de estado a Salvador Allende, por Augusto Pinochet apoyado por EUA. & NA & NA \\ 
A\~no Internacional de la Mujer: La Organizaci\\'on de las Naciones Unidas (ONU) declar\\'o 1975 como el A\~no Internacional de la Mujer & 1975 & En la primavera de 1975, el ej\\'ercito norvietnamita lanz\\'o una ofensiva final, superando r\\'apidamente las defensas del Sur. El 30 de abril de 1975, Saig\\'on, la capital de Vietnam del Sur, cay\\'o y fue renombrada como Ho Chi Minh. & 1976: Reunificaci\\'on de Vietnam
 & NA & NA \\ 
1981:J\"urgen Habermaspublica \textquotedblleftLa Teor\\'ia de la Acci\\'on Comunicativa\textquotedblright en dos vol\\'umenes en 1981 & 1983 & 1982: Richard Rortypublica Consequences of Pragmatism (esseys 1972-1980) & 1982: Apogeo de las manifestaciones en EUA a favor del desearme nuclear.
...
Robert Nozick:
Publica "The examined life" y dentro de este libro el ensayo "The sigzag of politics" donde expone "La posici\\'on libertaria que una vez propuse me parece ahora seriamente incorrecta". & 1989 & Charles Taylorpublica \textquotedblleftSources of the self\textquotedblright. Hizo su tesis doctoral con Isaiah Berlin y es un referente de la corriente del Comunitarismo. & 1989: Cae el muro de Berl\\'in.
1989: Revoluci\\'on de Terciopelo, ca\\'ida del r\\'egimen comunista en Checoslovaquia. & NA & NA \\ 
El pakistan\\'i Mahbub ul-Haq, junto con Amartya Sen, escriben para la PNUD el primer Informe de Desarrollo Humano; el cual inclu\\'ia la primera presentaci\\'on del IDH. & 1990 & Se crea el IFE en M\\'exico, el 11-oct-1990 & 1990: Termina la dictadura de Pinochet en Chile. En 1988 hab\\'ia ganado el \textquotedblleftNo\textquotedblright en el plebiscito.
1990: Mandela se dirige al Comit\\'e Especial contra el Apartheid en la ONU. & M\\'exico & NA \\ 
NA & 1991 & NA & 1991: Amartya Sen se casa con Emma Rothschild & NA & NA \\ 
NA & 1994 & NA & 1994: John F. Nash Jr. (nobel prize)
The Sveriges Riksbank Prize in Economic Sciences.\textquotedblleftfor their pioneering analysis of equilibria in the theory of non-cooperative games\textquotedblright
1994: Nelson Mandela toma posesi\\'on como primer presidente elegido democr\\'aticamente en Sud\\'africa. & NA & NA \\ 
1999: Amartya Sen con respecto a la hambruna de 1943 en la India \guillemotleftNinguna hambruna ha tenido nunca lugar en la historia del mundo en una democracia funcional\guillemotright, libro \guillemotleftDesarrollo y libertad\guillemotright de 1999. & 1998 & NA & 1998: Amartya Sen recibe el premio nobel de Econom\\'ia & NA & NA \\ 
...
2006-2009: Jos\\'e Manuel Zelaya Rosales, [a] Mel Zelaya, fue presidente de Honduras. & NA & NA \\ 
NA & 2009 & NA & 2009: Manuel Zelaya
Llama a Plebiscito para consultar sobre una Asamblea Nacional Constituyente el 28/jun/2009. El d\\'ia se\~nalado se realiza un golpe de estado; el congreso sesiona y declara su destituci\\'on. & NA & NA \\ 
NA & 2014 & El IFE adquiere car\\'acter nacional y se transforma en el Instituto Nacional Electoral (INE) & 2014-2022: Juan Orlando Hern\\'andez Alvarado, (a) JOH, fue presidente de Honduras & NA & NA \\ 
NA & 2018 & NA & 2018-2024: periodo presidencial de Andr\\'es Manuel L\\'opez Obrador, AMLO, M\\'exico & M\\'exico & NA \\ 
NA & 2022 & NA & 2022-2026: Xiomara Castro es presidenta de Honduras & NA & NA \\ 
La educaci\\'on en la NEM est\\'a orientada a formar ciudadanos capaces de ejercitar valores \\'eticos y democr\\'aticos con un sentido social.  & 2023  & La NEM desea formar personas capaces de conducirse como ciudadanos aut\\'onomos.  &   & NA & NA \\ 
NA & 2024 & NA & 2024-2030: Claudia Sheinbaum presidenta de M\\'exico & NA & NA \\ 
\bottomrule
\end{tabular*}
\begin{minipage}{\linewidth}
\textsuperscript{\textit{1}}La columna de -Evento- se\~nala lo principal a resaltar en esa fecha. -Observaci\\'on- pretende ser la descripci\\'on, -contexto- son los eventos que suced\\'ian en paralelo. \\
\end{minipage}
\end{table}
...
\bibitem[\citeproctext]{ref-bear2017}
Bear, Christopher. 2017. \emph{Socio{-}Nature}. 1.ª ed. Editado por
Douglas Richardson, Noel Castree, Michael F. Goodchild, Audrey
Kobayashi, Weidong Liu, y Richard A. Marston. Wiley, 2017.
\url{https://doi.org/10.1002/9781118786352.wbieg0212}.
...
\bibitem[\citeproctext]{ref-castillofarjat2023}
Castillo Farjat, Luis Alfonso. 2023a. {«Espacios autónomos y autogestión
comunitaria en la sierra sur de Oaxaca»}. \emph{Relaciones Estudios de
Historia y Sociedad} 43 (171): 27-44.
\url{https://doi.org/10.24901/rehs.v43i171.913}.

\bibitem[\citeproctext]{ref-castillofarjat2023a}
---------. 2023b. {«Espacios autónomos y autogestión comunitaria en la
sierra sur de Oaxaca»}. \emph{Relaciones Estudios de Historia y
Sociedad} 43 (171): 27-44.
\url{https://doi.org/10.24901/rehs.v43i171.913}.

\bibitem[\citeproctext]{ref-castillofarjat2026}
---------. 2026. {«Territorios hidrosociales y waterscape: marcos
analíticos para el estudio crítico del agua»}. \emph{Quivera Revista de
Estudios Territoriales} 28 (1): 117.
\url{https://doi.org/10.36677/qret.v28i1.26265}.
...
\bibitem[\citeproctext]{ref-lefebvre2013}
Lefebvre, Henri. 2013. \emph{La producción del espacio}. 1ª ed. Madrid:
Capitán Swing, 2013.
...
\bibitem[\citeproctext]{ref-peuxf1agarcuxeda2019}
Peña García, Alejandra. 2019. {«Ibarra, María Verónica y Talledos, E.
(Coords). (2016). Megaproyectos en México: una lectura crítica»}.
\emph{Tlalli: Revista de Investigación en Geografía}, n.º 1: 223-27.
\url{https://dialnet.unirioja.es/servlet/articulo?codigo=8287248}.

\bibitem[\citeproctext]{ref-plantin2016}
Plantin, Jean-Christophe, Carl Lagoze, Paul N Edwards, y Christian
Sandvig. 2016. {«Infrastructure Studies Meet Platform Studies in the Age
of Google and Facebook»}. \emph{New Media \& Society} 20 (1): 293-310.
\url{https://doi.org/10.1177/1461444816661553}.

\bibitem[\citeproctext]{ref-poell2019a}
Poell, Thomas, David Nieborg, y José van Dijck. 2019.
{«Platformisation»}. \emph{Internet Policy Review} 8 (4).
\url{https://doi.org/10.14763/2019.4.1425}.
...
\bibitem[\citeproctext]{ref-santos2005a}
Santos, Milton. 2005. \emph{La Naturaleza del Espacio}. España:
